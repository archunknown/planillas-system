...
export const configMypeMicro: ConfigRegimen = {
...
export const configMypePequena: ConfigRegimen = {
...
export function calcularPlanillaMype(datos: DatosPeriodoInput, esMicro: boolean, cuotaSisMicro: number = 15): ResultadoPlanilla {
  ...
  const asignacionFamiliar = esMicro
    ? 0
    : calcularAsignacionFamiliar(datos.rmv, datos.tieneAsignacionFamiliar, false, datos.cantidadHijos);
